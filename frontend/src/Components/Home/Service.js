                ...
                <div className='container my-5 py-5'>
                    ...
                    <div className='row mt-5'>
                        <div className='col-md-4'>
                            <div class="card p-3">
                                <div class="card-body text-center">
                                    <i className='fa fa-cogs fa-4x mb-4 text-success'/>
                        ...
                        <div className='col-md-4'>
                            <div class="card p-3">
                                <div class="card-body text-center">
                                    <i className='fa fa-mobile fa-4x mb-4 text-success'/>
                        ...
                        <div className='col-md-4'>
                            <div class="card p-3">
                                <div class="card-body text-center">
                                    <i className='fa fa-users fa-4x mb-4 text-success'/>
                    ...
                    <div className='row mt-5'>
                        <div className='col-md-4'>
                            <div class="card p-3">
                                <div class="card-body text-center">
                                    <i className='fa fa-laptop fa-4x mb-4 text-success'/>
                        ...
                        <div className='col-md-4'>
                            <div class="card p-3">
                                <div class="card-body text-center">
                                    <i className='fa fa-file-code-o fa-4x mb-4 text-success'/>
                        ...
                        <div className='col-md-4'>
                            <div class="card p-3">
                                <div class="card-body text-center">
                                    <i className='fa fa-star-half-o fa-4x mb-4 text-success'/>
